...
#  sys.path.append(os.path.join(os.path.dirname(__file__), '..', '01Knapsack', 'Algorithms', 'classes')) 
...
# sys.path.append(os.path.join(p, '..', '01Knapsack', 'Algorithms', 'classes'))
# sys.path.append(os.path.join(p, '..', '01Knapsack', 'Algorithms', 'DynamicProgramming'))
